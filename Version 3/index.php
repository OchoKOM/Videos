...
<body>
    ...
    <nav class="top-nav">
        <ul>
            ...
            <li class="search">
                <form action="search" method="get" name="q" autocomplete="false">
                    <span>
                    ...
                    <div class="inputbox">
                        <input type="search" placeholder="Chercher" name="q" id="search" required>
                    </div>
...
<div class="content">
        ...
        <?php
                ...
                <?php
                    ...
                    //todo:  Code generé à chaque fois qu'il y a une nouvelle donnée dans la base des données
                        ?>
                    <div class="links">
