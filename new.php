        ...
        <ul>
            ...
            <li class="active">
                <a class="btn-icon" href="#">
                    <svg class="new-icon" height="48" viewBox="0 -960 960 960" width="48">
...
<div class="postcont">
    ...
    <div class="file-size" data-upload="Aucun fichier en cours" data-progress="">
                <div class= "message">
                </div>
                <svg class="upload-progress">
                    <circle class="track" cx="100" cy="100" r="90"></circle>
                    <circle class="progress warning" cx="100" cy="100" r="90" style="--w: 50;"></circle>
                </svg>
            </div>
            <div class="confirms">
                <a href="#" class="btn btn-success new edit">Modifier</a>
                <a href="#" class="btn btn-warning new" onclick="addVideo()">↺ Une autre video</a>
                <a href="#" class="btn btn-danger retry" onclick="addVideo()">↺ Ressayer</a>
                <a href="<?=$_SESSION["pseudo"]?>/videos" class="btn btn-primary">Mes videos</a>
            </div>
            <div class="post-body">
            <div class="preview">
                <div class="videoPl">
                ...
                <div class="vidBtn">
                    ...
                    <label for="vidBtn" title="Cliquez ici" class="i vd"><i class="fa fa-video"></i></label>
                </div>
                ...
                <div class="vidBtn">
                    ...
                    <div class="imgPrev">
                        <img  width="190px" class="posterView" style="display:none;">
                    </div>
                    <label for="imgBtn" title="Cliquez ici" class="i im" ><i class="fa fa-image"></i></label>
                </div>
            <div class="title">
        ...
        <script src="scripts/preview/new.js"></script>
    </div>
</div>
        ...
        <div class="topbar">
            <ul>
                ...
                <li>
                    ...
                    <a href="new">
                        <span class="icon">
                            <svg class="new-icon" viewBox="0 -960 960 960" style="height: 1em;">
                                <path fill="currentColor" d="M453-280h60v-166h167v-60H513v-174h-60v174H280v60h173v166Zm27.266 200q-82.734 0-155.5-31.5t-127.266-86q-54.5-54.5-86-127.341Q80-397.681 80-480.5q0-82.819 31.5-155.659Q143-709 197.5-763t127.341-85.5Q397.681-880 480.5-880q82.819 0 155.659 31.5Q709-817 763-763t85.5 127Q880-563 880-480.266q0 82.734-31.5 155.5T763-197.684q-54 54.316-127 86Q563-80 480.266-80Z"/>
                            </svg>
                        </span>
                    </a>   
    ...
    <div class="post-content">
        ...
        <form method="post" enctype="multipart/form-data" id="newvideo">
            ...
            <div class="preview">
                ...
                <!-- <div class="vidBtn previd">
                    <p class="instruction">Cliquez sur <span class="fa fa-film"></span> pour selectionner une image <br> à partir de la vidéo</p>
                    <div class="imgVdPrev">
                        <img src="" width="190px" class="posterVdView" style="display:none;">
                    </div>
                    <label title="Cliquez ici" class="i iv"><i class="fa fa-film"></i></label>
                </div> -->
                <br>
            <div class="title">
                <label for="title">Titre de la video</label>
            ...
            <div class="videoPl">
                <div class="vid" >
                    <video id="vid" class="vidPrev" loop></video>
                </div>
            </div>
            </div>
            <div align=center class="post-footer">   
