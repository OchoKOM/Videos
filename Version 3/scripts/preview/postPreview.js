...
formD.addEventListener("submit", e=>{
  ...
  xhr.upload.addEventListener("progress", ({loaded, total})=>{
    ...
    uploadProgress.classList.contains("warning") ? uploadProgress.classList.remove("warning") : uploadProgress.classList.add('uploading')
    ...
    if (loaded === total) {
      ...
      let sessName = document.getElementById("sessName").value;      
      setTimeout(() => {
