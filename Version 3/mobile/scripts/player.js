...
<img src="scripts/controls/ico.png" alt="webicon" class="webicon">
          ...
          <div class="icon myicons">
            <span id="loopToggle">
              <svg
                ...
                viewBox="0 0 48 48"
                style="width: 100%">
                <pathfill="currentColor" d="m14 44-8-8 8-8 2.1 2.2-4.3 4.3H35v-8h3v11H11.8l4.3 4.3Zm9.3-14.1v-9.45h-2.8V18h5.25v11.9ZM10 21.5v-11h26.2l-4.3-4.3L34 4l8 8-8 8-2.1-2.2 4.3-4.3H13v8Z"/>
              </svg>
              <svg class="fabtn loop" id="loopOn" viewBox="0 0 48 48">
                <path
                  fill="currentColor"
