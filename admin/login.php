...
<?php if (($devicecheck == 1)) { ?>
            ...
            <ul>
                ...
                <li>
                    ...
                    <form method="post" class="login-menu" action="">
                        ...
                        ?>
                        <div class="signup"> Nouveau ici ? <a ref="login?auth=signup">Inscription</a></div>
                    </form>            
                            <?php
                        }
                    ?> 
    ...
    <?php
        if (isset($_COOKIE['users']) && !isset($_GET['auth']) ) {
            ?><div class="container saved-users <?php if (($devicecheck == 1)) { ?>mobile<?php } ?>">
                    ...
                    foreach ($_COOKIE['users'] as $id => $value) {
                        ...
                        <div class="savedPb">
                            <label class="overlay" for="connectUsrp<?=$userId?>"></label>
                                <?php
                                    if ($getUserInf['avatar'] != "admin/noprofil.jpg") {
                                        ?>
                                            <img src="<?=$userPdp?>" alt="">
                                        <?php
                                    }else {
            ...
            <div class="newUser">
                ...
                <div class="addUser new">
                    <a class="submit" href="login?auth=signup">
                        Créer un nouveau compte
                    </a>
                </div>
            </div>
        </div><?php
        }elseif (isset($_GET['auth']) && $_GET['auth'] == "signup") {
            ?>
            <div class="login <?php if (($devicecheck == 1)) { ?>mobile<?php } ?>">
                <form method="post" class="login-menu" action="">
                    <h2>Inscription </h2> 
                    <input type="text" name="pseudo" class="input" placeholder="Pseudo" required>
                    <input type="password" name="mdp" class="input" placeholder="Mot de passe" required>
                    <input type="password" name="mdp1" class="input" placeholder="Confirmer" required>
                    <div class="rememberme"> 
                        <input checked style="cursor:pointer;accent-color:#1e9bff;" type="checkbox" name="rememberme" id="rememberme"> 
                    ...
                    ?>
                    <div class="signup"> Compte existant ? <a href="login">Connexion</a></div>
                </form>
            </div>
            <?php
        }else {
