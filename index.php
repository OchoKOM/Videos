...
<div class="content">
        ...
        <?php
                ...
                <h3>Aucune vidéo n'a été publié pour l'instant 
                    <button class="btn btn-warning" id="mod">Cliquez Ici</button> pour être le premier à publier une video
                </h3>
                <script>
                        ...
                        <div class="thumbNails" data-mini="<?=$row['id']?>">
                            <a>
                                <div class="mini-player" >
                                    ...
                                    <video src="#"onclick="location.replace('watch?v=<?=$row['id']?>')"></video>
                                    <button title="Lire">
