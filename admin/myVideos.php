...
<head>
    ...
    <?php if (($devicecheck == 1)) { ?>
        <link rel="stylesheet" href="../styles/all/mobile_navbar.css"><?php } else {  ?>
        <link rel="stylesheet" href="../styles/all/navbar.css"><?php } ?>
...
<body style="--bg:#222">
    <?php if (($devicecheck == 1)) { ?>
        ...
        <nav class="bottom-nav">
            <ul>
                ...
                <li>
                    <a class="btn-icon active" href="#">
                        <svg viewBox="0 -960 960 960" class="play-icon" >
                            <path d="m460-380 280-180-280-180v360ZM320-240q-33 0-56.5-23.5T240-320v-480q0-33 23.5-56.5T320-880h480q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H320ZM160-80q-33 0-56.5-23.5T80-160v-560h80v560h560v80H160Z"  fill="currentColor"/>
                        </svg>
                        <span class="btn-text">
                            Videos
                        </span>
    ...
    <div class="profileBx <?php if (($devicecheck == 1)) { ?>mobile<?php } ?>">
        <a href="../<?= $_GET['vs'] ?>">
            <div class="user-pic">
                <?php if ($InfoUs['avatar'] != "admin/noprofil.jpg") {?>
                    <img src="<?= $avatar ?>" alt="<?= $pseudo ?>'s Profile"> 
                <?php }?>
            </div>
        </a>
        <?php
        ...
        ?>
            <h3>Videos mises en ligne par <a href="../<?= $_GET['vs'] ?>">
                    <?= $pseudo ?>
                </a></h3>
        <?php
        } else {
        ?>
            <h3>Videos en ligne</h3>
        <?php
        }
        ?>
    </div>
                    ...
                    <div class="vidInfos">
                        <div class="top">
                            ...
                            <div class="date">
                                ...
                                <p><span><?= $views ?></span>
                                <p class="time" data-date="<?= $getDate ?>"> • Il y a 0s</p>
                                </p>
                            </div>
                        </div>
                        ...
                        ?>
                            <div class="bottom-h setting">
                                <a href="../edit_video/<?= $id ?>"> 
                                    <svg viewBox="0 -960 960 960">
                                        <path fill="currentColor" d="M100.001-180.001v-599.998h759.998V-520H800v-200H160v480h320v59.999H100.001Zm290-138.462v-323.074L641.537-480 390.001-318.463ZM714-83.849l-8.154-47.307q-17.385-5-30-12.231-12.616-7.231-24.77-17.923l-44.922 16.076-31.538-51.075 37.154-31.538q-4.693-17.847-4.693-33.693 0-15.846 4.693-33.693l-37.154-31.538 31.538-51.075 44.922 16.076q12.154-10.692 24.77-17.923 12.615-7.231 30-12.231L714-439.231h59.999l8.153 47.307q17.385 5 30.001 12.539 12.615 7.538 24.769 18.846l44.922-17.307 31.538 52.306-37.153 31.538q4.692 16.616 4.692 33.077 0 16.462-4.692 33.078l37.153 31.538-31.538 51.075-44.922-16.076q-12.154 10.692-24.769 17.923-12.616 7.231-30.001 12.231l-8.153 47.307H714Zm29.999-94.614q34.154 0 58.616-24.461 24.461-24.462 24.461-58.616 0-34.154-24.461-58.616-24.462-24.461-58.616-24.461-34.154 0-58.615 24.461-24.462 24.462-24.462 58.616 0 34.154 24.462 58.616 24.461 24.461 58.615 24.461Z"/>
                                    </svg>
                                    <span>Modifier</span>
                                </a>
                            </div>
