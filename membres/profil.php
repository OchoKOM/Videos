...
if ($getUsereq->rowcount() == 0) {
    ...
    $getUserreq->execute(array($_GET['id']));
}
...
if (isset($_SESSION['auth']) && $_GET['id'] === $_SESSION['id']) {
?>
<!DOCTYPE html>
<html lang="fr">
...
<nav>
    ...
    <div class="nav">
        ...
        <div class="menu">
            ...
            <li><a href="../my_videos/<?= $_SESSION['id']; ?>"><i class="fa fa-video-camera" aria-hidden="true"></i> Mes
                    Créations</a></li>
    ...
    if (isset($msg)) {
        ...
        <div class="btns ed">
            <a style="--clr:#4ff321" href="../my_videos/<?= $_SESSION['id']; ?>">
                <p>Mes Videos</p>
            </a>
        </div>
    </div>
...
<nav>
    ...
    <div class="nav">
        ...
        <div class="menu">
            ...
            <li><a href="<?= $_SESSION['id']; ?>"><i class="fa fa-user-circle"></i>Voir mon profil</a></li>
            <li><a href="history"><i class="fa fa-history"></i>Voir Mon Historique</a></li>
            <li><a href="../my_videos/<?= $_SESSION['id']; ?>"><i class="fa fa-video-camera" aria-hidden="true"></i>Voir Mes Créations</a></li>
            <li><a><i class="fa fa-question" aria-hidden="true"></i> Aide et Support</a></li>
        </div>
    </div>
    <script>
    ...
    if (isset($msg)) {
        ...
        <div class="btns ed">
            <a style="--clr:#ff0" href="../my_videos/<?= $_GET['id']; ?>"><button name="edit">Voir ses
                    videos</button></a>
        </div>
    </div>
</body>
